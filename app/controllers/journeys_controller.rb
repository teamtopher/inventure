class JourneysController < ApplicationController
  ...
  private
    ...
    def journey_params
      params.require(:journey).permit(:validation, :first_clue, :first_image, :user_id, :answer, :image, :remote_image_url, :name, :difficulty, :description, clues_attributes: [:remote_image_url, :image, :content, :id, :_destroy])
    end
    def check_user
