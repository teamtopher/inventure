...
class JourneysControllerTest < ActionController::TestCase
  ...
  test "should create journey" do
    assert_difference('Journey.count') do
      post :create, journey: { description: @journey.description, difficulty: @journey.difficulty, name: @journey.name }
    end
  ...
  test "should update journey" do
    patch :update, id: @journey, journey: { description: @journey.description, difficulty: @journey.difficulty, name: @journey.name }
    assert_redirected_to journey_path(assigns(:journey))
  end
